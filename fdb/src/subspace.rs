...
mod tests {
    ...
    fn new() {
        ...
        assert!(
            s.raw_prefix_has_incomplete_versionstamp == false
    ...
    fn subspace() {
        ...
        assert!(s.raw_prefix_has_incomplete_versionstamp == false && s.raw_prefix == t.pack());
        ...
        assert!(s.raw_prefix_has_incomplete_versionstamp == true && s.raw_prefix == t.pack());
    }
    ...
    fn range() {
        ...
        assert_eq!(
            ...
            Range::new(
                Bytes::from_static(&b"prefix\x01foo\x00\x00"[..]).into(),
                Bytes::from_static(&b"prefix\x01foo\x00\xFF"[..]).into()
            )
        );
    }
